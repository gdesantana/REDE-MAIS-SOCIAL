...
/**
 * classe que representa o perfil profissional do candidato (passo 4 da afiliação),
 * incluindo descrição, habilidades e interesses.
 */
public class Perfil {
    // id do registro na tabela 'perfil' (pk)
    private Integer id; 
    
    // chave estrangeira (fk): liga este perfil ao candidato proprietário
